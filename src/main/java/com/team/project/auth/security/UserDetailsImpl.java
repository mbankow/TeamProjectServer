...
public class UserDetailsImpl implements UserDetails {
    ...
    public static UserDetails build(User user){
        List<GrantedAuthority> grantedAuthorities = Collections.singletonList(user.getRole());
        return new UserDetailsImpl(user.getEmail(), user.getPassword(), grantedAuthorities);
    }
